...
//end section to send the appointment	
    ...
    <FormGroup className='checkbox-container'>
		<FormControlLabel control={<Checkbox id={'1'} key={'1'} value={'15:00-15:30'} onChange={handleChange} />} label="15:00 hs - 15:30hs" />
		<FormControlLabel control={<Checkbox id={'2'} key={'2'} value={'15:30-16:00'} onClick={handleChange} />} label="15:30 hs - 16:00hs" />
		<FormControlLabel control={<Checkbox id={'3'} key={'3'} value={'16:00-16:30'} onClick={handleChange} />} label="16:00 hs - 16:30hs" />
		<FormControlLabel control={<Checkbox id={'4'} key={'4'} value={'16:30-17:00'} onClick={handleChange} />} label="16:30 hs - 17:00hs" />
		...
		<FormControlLabel control={<Checkbox id={'10'} key={'10'} value={'19:30-20:00'} onClick={handleChange} checked disabled/>} label="19:00 hs - 19:30hs" />
